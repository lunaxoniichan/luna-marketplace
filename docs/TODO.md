...
| T5 | Fleet sync (`sync-agent-views --all`) — generate plugin `rules/` into every registry project (ADR Option A). | `docs/plans/2026-07-18-luna-studio.md` | phase-2 | open |
| T6 | Gateway hardening: per-vault mutation mutex, error normalization, body size cap, ctx env-gate. | `docs/plans/2026-07-18-luna-studio.md` | phase-2 | open |
